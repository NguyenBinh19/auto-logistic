...
import HotelSearchForm from "@/components/demo/Agency/DemoSearchForm.jsx"; // Sử dụng form demo
import { History, Star, Gift, Crown, Building2 } from "lucide-react";
import homepage from "@/assets/images/homepage.jpg";

// Import các ảnh địa điểm (Đảm bảo đường dẫn chính xác như code chính)
...
export default function HotelSearchEngine() {
    ...
    const handleQuickSearch = (name) => {
        ...
        // Chuyển hướng đến trang danh sách khách sạn demo (hoặc trang list của bạn)
...
// Component phụ hiển thị Card địa điểm
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-5 left-6 text-white">
                <h3 className="text-2xl font-black drop-shadow-md uppercase tracking-tighter">{dest.name}</h3>
            </div>
        </div>
    );
}
